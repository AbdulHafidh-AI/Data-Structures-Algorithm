...
/*
Stack dapat menggunakan array ataupun  linked list.
Jika kita memakai array, ukuran stack nya sebesar ukuran array yg didefinisikan. Klo pkk linked list, ukuran memorinya 
sampai memory heap pada perangkat tersebut tidak tersisa lagi untuk membuat node baru untuk linked list nya, biasa disebut overflown.
